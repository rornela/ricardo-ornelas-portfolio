...
const projects: Project[] = [
  {
    ...
    description: 'A "Scan-to-Estimate" embeddable widget for aesthetic clinics using browser-based computer vision to analyze facial muscles and calculate personalized Botox dosage.',
    technologies: ['Next.js 16', 'TypeScript', 'Tailwind CSS', 'Supabase', 'Google MediaPipe', 'OpenAI API', 'esbuild'],
    year: '2026',
    link: 'https://visual-retain-git-ui-redesign-centric-8407c316.vercel.app/login?redirectTo=%2Fdashboard',
    highlights: [
      'Implemented real-time facial landmark detection (468 points) directly in the browser using WebAssembly (MediaPipe)',
      'Designed a standalone build pipeline using esbuild to bundle the widget into a single embeddable script',
      'Developed a hybrid analysis engine combining client-side CV with server-side OpenAI for medical dosage estimation',
      'Built a secure SaaS dashboard for clinics to manage leads and view patient photos using Next.js 16 and Supabase RLS',
      'Solved cross-origin communication issues between host websites and the widget using window.postMessage'
    ]
  },
  {
    id: 2,
...
const styles = StyleSheet.create({
  ...
  heroSection: {
    minHeight: width < 768 ? height * 0.7 : height * 0.8,
  ...
  techCard: {
    ...
    borderRadius: 8,
    minWidth: width < 768 ? (width - 56) / 2 : 200,
    maxWidth: width < 768 ? (width - 56) / 2 : 250,
    alignItems: 'center',
    borderWidth: 1,
    borderColor: '#f0f0f0',
  },
  ...
  heroDescription: {
    ...
    maxWidth: width < 768 ? width - 32 : 600,
  },
  heroStats: {
    flexDirection: 'row',
    justifyContent: 'space-around',
    width: '100%',
    maxWidth: width < 768 ? width - 32 : 400,
    marginBottom: width < 768 ? 32 : 48,
  },
  statItem: {
    alignItems: 'center',
  ...
  section: {
    paddingHorizontal: width < 768 ? 16 : 24,
    paddingVertical: width < 768 ? 40 : 60,
  },
  sectionTitle: {
